...
const sections = [
  {
    ...
    image: "/content-writing.png", // Replace with your image path
    description:
      "We are a team of professional writers who create engaging and informative content for businesses and individuals.",
    bullets: [
      "High-quality, brand-aligned writing.",
      "Latest SEO techniques for better ranking.",
      "Product listing optimization for sales.",
  ...
  {
    title: "Sales Funnel",
    image: "/sales-funnel.png", // Replace with your image path
    description:
      "Our custom funnels guide your customers from awareness to purchase using optimized strategies and automation.",
    bullets: [
      "Improved customer targeting.",
      "Increased conversions & automation.",
      "Time & cost-efficient systems.",
      "Better customer retention.",
      "Fully customizable funnel journeys.",
    ],
  },
];
          ...
          >
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl font-bold">
                Welcome to our Content Writing Services!
              </h1>
              <p className="text-lg text-white/80">
                We specialize in content that ranks, converts, and engages — including blogs, product descriptions, and sales funnels that perform.
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-container relative z-10">
        ...
        >
          ...
          <p className="text-body text-white/80 mt-4 max-w-2xl mx-auto">
            We’ve helped 1000+ brands grow with compelling content and smart funnels.
          </p>
